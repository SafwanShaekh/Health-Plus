...
myApp.config(['$routeProvider',function($routeProvider){
    ...
    .when('/add-medicine-dosage',{templateUrl: 'Views/add-medicine-dosage.html'})
    .when('/view-medicine-dosage',{templateUrl: 'Views/view-medicine-dosage.html'})
    .when('/add-health-vitals',{templateUrl: 'Views/add-health-vitals.html'})
    .when('/view-health-vitals',{templateUrl: 'Views/view-health-vitals.html'})
